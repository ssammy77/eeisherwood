...
doc = Document('/home/user/.openclaw/media/inbound/NW_-_blurbs_ten_books---28936a6d-4a4f-4174-85b8-b38f705dbcf3.docx')

books_info = {
    1: {
        'asin': 'B09BG4VPXH', 'isbn13': '979-8773147008', 'published': 'July 29, 2021', 'wordCount': 99000,
        'reviews': [
            {'author': 'R.MacLean', 'date': 'November 19, 2023', 'rating': '5.0', 'title': 'Good Story, Well Told -- a fresher and more nuanced post-apocalyptic tale',
            ...
            {'author': 'KikiC', 'date': 'November 19, 2025', 'rating': '5.0', 'title': "I'm hooked!",
    ...
    2: {
        'asin': 'B09XGWRNK3', 'isbn13': '979-8352366868', 'published': 'April 7, 2022', 'wordCount': 81000,
        'reviews': [
            {'author': 'Liz', 'date': 'December 28, 2023', 'rating': '5.0', 'title': 'A 5-star series',
             'body': 'I highly recommend this series. The story plot is creative, entertainment and action packed. The characters are perfect for this kind of situation. I am on book 3 and love every minute of it!'},
            {'author': 'Ami A.', 'date': 'May 15, 2022', 'rating': '5.0', 'title': 'Excellent apocalyptic tale!',
    ...
    3: {
        'asin': 'B0BHBXPKNF', 'isbn13': '979-8356460715', 'published': 'October 4, 2022', 'wordCount': 97000,
        'reviews': [
            {'author': 'Kindle Customer', 'date': 'August 13, 2024', 'rating': '5.0', 'title': 'Neighborhood watch',
            ...
            {'author': 'Taylor', 'date': 'May 15, 2024', 'rating': '5.0', 'title': 'Excellent read',
    ...
    4: {
        'asin': 'B0BMGD7WSD', 'isbn13': '979-8366365383', 'published': 'November 15, 2022', 'wordCount': 99000,
        'reviews': [
            {'author': 'MMIrish1371', 'date': 'February 8, 2025', 'rating': '5.0', 'title': "four books in and I can't get enough",
            ...
            {'author': 'linda moses', 'date': 'February 17, 2025', 'rating': '5.0', 'title': 'Neighborhood Hood Watch/1000 Miles of Bad Road',
    ...
    5: {
        'asin': 'B0BQGZQYVJ', 'isbn13': '979-8376057308', 'published': 'January 30, 2023', 'wordCount': 77000,
        'reviews': [
            {'author': 'Del Hicks', 'date': 'January 28, 2026', 'rating': '5.0', 'title': 'Adrenaline rush',
            ...
            {'author': 'zedlivesay', 'date': 'February 5, 2023', 'rating': '5.0', 'title': 'This Series Just Gets Better and Better',
    ...
    6: {
        'asin': 'B0BSNWDLR2', 'isbn13': '979-8387173479', 'published': 'March 24, 2023', 'wordCount': 86000,
        'reviews': [
            {'author': 'Sandra Fortenberry', 'date': 'March 31, 2023', 'rating': '5.0', 'title': 'This is why I read apocalypse books',
            ...
            {'author': 'Ellen Clason', 'date': 'April 8, 2023', 'rating': '5.0', 'title': 'And the story gets better with each new book',
    ...
    7: {
        'asin': 'B0BYTDS1DY', 'isbn13': '979-8396032743', 'published': 'May 24, 2023', 'wordCount': 86000,
        'reviews': [
            {'author': 'Rallie', 'date': 'June 5, 2023', 'rating': '5.0', 'title': 'LOVE THIS SERIES!',
            ...
            {'author': 'Steve Martin', 'date': 'July 25, 2023', 'rating': '5.0', 'title': 'A Great Read',
    ...
    8: {
        'asin': 'B0C5S45QXW', 'isbn13': '979-8858380030', 'published': 'August 19, 2023', 'wordCount': 92000,
        'reviews': [
            {'author': 'Walt', 'date': 'June 21, 2025', 'rating': '5.0', 'title': 'Eight',
            ...
            {'author': 'Cindy Clark', 'date': 'August 29, 2023', 'rating': '5.0', 'title': 'Favorite author ever!!!',
    ...
    9: {
        'asin': 'B0CFG4B5F7', 'isbn13': '979-8863375137', 'published': 'October 4, 2023', 'wordCount': 82000,
        'reviews': [
            {'author': 'Christopher Haught', 'date': 'October 13, 2023', 'rating': '5.0', 'title': 'Wow is all I can say!',
            ...
            {'author': 'Jesse R.', 'date': 'July 18, 2024', 'rating': '5.0', 'title': 'Great entertainment!',
    ...
    10: {
        'asin': 'B0CJYK9LZK', 'isbn13': '979-8873731367', 'published': 'December 19, 2023', 'wordCount': 105000,
        'reviews': [
            {'author': 'Gerald', 'date': 'April 24, 2024', 'rating': '5.0', 'title': 'I read every book and they all get 5 stars!',
            ...
            {'author': 'Robert P. Rockhill', 'date': 'July 25, 2024', 'rating': '5.0', 'title': 'Wonderful Read',
...
with open('/home/user/eeisherwood-site/src/lib/nw-book-data.json', 'w') as f:
    json.dump(books_info, f, indent=2)

print("Done - saved nw-book-data.json")
for n in sorted(books_info.keys()):
    b = books_info[n]
    print(f"  Book {n}: ASIN={b['asin']}, WC={b['wordCount']}, Reviews={len(b['reviews'])}")